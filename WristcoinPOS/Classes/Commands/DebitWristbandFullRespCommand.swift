...
@objc public class DebitWristbandFullRespCommand : NSObject, TCMPMessage{
    @objc public var commandFamily: [UInt8] = CommandFamily.wristcoinPOS
    
    @objc public var commandCode: UInt8 = WristcoinPOSCommandCode.debitWristbandFullResp.rawValue
